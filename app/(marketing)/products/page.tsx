...
const canonicalUrl = "https://suphancasting.com/products";
const siteUrl = "https://suphancasting.com";
const ogImage = `${siteUrl}/suphancasting-assets/gpt-hero/suphan-fcd-wide.webp`;
const products = [
  ["FC15-30", "SUC Pulley — FC15-30 Gray Cast Iron", "Pulley / drive gear casting สำหรับระบบส่งกำลังโรงสีและเครื่องจักรอุตสาหกรรม วัสดุ FC15-30 ครอบคลุม FC150, FC200, FC250, FC300 เหมาะกับงานหล่อเทา ลดแรงสั่นสะเทือน กลึงต่อได้ดี และคุมต้นทุนได้จริง.", "/suphancasting-assets/shopee-products/LINE_NOTE_260502_2.webp"],
  ["FCD45-70", "SUC Pulley — Ductile Iron", "FCD45-70 สำหรับพูลเล่ย์และชิ้นส่วนเครื่องจักรที่ต้องการความเหนียวและรับแรงกระแทกสูงกว่าเหล็กหล่อเทาทั่วไป ครอบคลุม FCD450, FCD500, FCD600 และ FCD700.", "/suphancasting-assets/shopee-products/LINE_NOTE_260502_5.webp"],
  ["Sc46", "Cast Steel Machinery Parts", "Sc46 สำหรับงานเหล็กกล้าหล่อ ชิ้นส่วนรับแรง งานโครงสร้าง และงานโรงงานที่ต้องควบคุมกระบวนการผลิตอย่างจริงจัง.", "/suphancasting-assets/shopee-products/LINE_NOTE_260502_10.webp"],
  ["S45c/S50c", "Machinery Shafts / Hubs / Carbon Steel Parts", "S45c และ S50c สำหรับชิ้นงานที่ต้องการความแข็งแรง งานกลึงต่อ งาน hub, shaft และอะไหล่เครื่องจักรตามแบบเฉพาะ.", "/suphancasting-assets/shopee-products/LINE_NOTE_260502_15.webp"],
  ["Mo4140", "High Strength Heavy-Duty Components", "Mo4140, 4340 และ SCMn สำหรับงานหนัก งานแข็งแรงสูง ชิ้นส่วนเฉพาะทาง และงานซ่อมบำรุงที่ต้องลด downtime.", "/suphancasting-assets/shopee-products/LINE_NOTE_260502_20.webp"],
  ["Cr2828", "Wear Resistant Castings", "Cr2828, ASTM A532 Class A และ Ni-Hard สำหรับชิ้นส่วนที่ต้องรับการเสียดสี งานสึกหรอสูง และสภาพใช้งานหนัก.", "/suphancasting-assets/shopee-products/LINE_NOTE_260502_10.webp"],
  ["1.4777/1.4823", "Heat Resistant Castings", "1.4777, 1.4823 และ ASTM สำหรับงานทนความร้อนและชิ้นส่วนที่ใช้งานในสภาพอุณหภูมิสูง.", "/suphancasting-assets/shopee-products/LINE_NOTE_260502_1.webp"],
] as const;

export const metadata: Metadata = {
  title: "รับหล่อโลหะ รับหล่อเหล็กตามแบบ | สินค้า Suphancasting",
  ...
  openGraph: {
    title: "รับหล่อโลหะ รับหล่อเหล็กตามแบบ | Suphancasting",
    description: `สินค้าและผลงานจริงของ Suphancasting สำหรับงานหล่อเหล็ก พูลเล่ย์ เฟือง และอะไหล่เครื่องจักรจากวัสดุ ${materialList}`,
    url: canonicalUrl,
    type: "website",
    siteName: "Suphancasting",
    locale: "th_TH",
    images: [{ url: ogImage, width: 1200, height: 630, alt: "Suphancasting product portfolio" }],
  },
  twitter: {
...
export default function ProductsPage() {
  ...
  const collectionJsonLd = {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    name: "สินค้าและผลงาน Suphancasting",
    url: canonicalUrl,
    inLanguage: "th-TH",

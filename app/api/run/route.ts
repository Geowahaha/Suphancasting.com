...
const PROMPTS = {
  'blog-post': 'You are a professional content writer for Suphancasting, a precision metal casting factory in Thailand (since 2022). Write a comprehensive blog post about {topic}. Format with markdown headings.',
